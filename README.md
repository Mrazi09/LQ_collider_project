...
**MadGraph_codes** Auxiliary python code for contructing MadGraph parameter cards as well as a python interface with MadGraph to generate events. Also includes analysis codes for extraction of kinematic/angular observables from .root files
