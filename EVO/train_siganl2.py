...
# Choose between accuracy or asimov mode
accuracy_mode = False
asimov_mode = True
...
def train_and_score(network, dataset):
    ...
    if accuracy_mode == True:
        ...
        with open("/media/joao/TOSHIBA EXT/Machine_learning/EVO/models_accuracy/NN_ACC_{:.10f}.json".format(score[1]), "w") as json_file:
            json_file.write(model.to_json())

        model.save_weights("/media/joao/TOSHIBA EXT/Machine_learning/EVO/weights_accuracy/weights_ACC_{:.10f}.hdf5".format(score[1]))
    ...
    if asimov_mode == True:
        ...
        with open("/media/joao/TOSHIBA EXT/Machine_learning/EVO/models_asimov/NN_asimov_{:.10f}.json".format(score[1]), "w") as json_file:
            json_file.write(model.to_json())

        model.save_weights("/media/joao/TOSHIBA EXT/Machine_learning/EVO/weights_asimov/weights_asimov_{:.10f}.hdf5".format(score[1]))
