...
def main():
    ...
    #Background order: Diboson, ttbar, Z_plus_jets
    dataset = get_data('/media/joao/TOSHIBA EXT/Machine_learning/Data/X_train_1p5TeV.npz','/media/joao/TOSHIBA EXT/Machine_learning/Data/X_test_1p5TeV.npz', \
                  lumi=3000., sig_xs=0.23040527818452006, bg_xs=[32191.469264447667, 75269.65792903882, 10819462.000118723],
                  systematic=0.01)
