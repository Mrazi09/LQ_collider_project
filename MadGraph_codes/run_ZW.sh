...
cd /scratch_p/jpedropino/1-LQCollider-project/ZW
for i in {1..6}; do
...
echo "output Backgrounds/ZW_$i" >> Folder_commands_$i.sh
...
echo "./bin/mg5_aMC /scratch_p/jpedropino/1-LQCollider-project/ZW/Folder_commands_$i.sh" >> Production_commands_$i.sh
echo "cd /home/jpedropino@UA.PT/Workstation/MadGraph/MG5_aMC_v2_7_0" >> Production_commands_$i.sh
echo "./bin/mg5_aMC /scratch_p/jpedropino/1-LQCollider-project/ZW/Scan_commands_$i.sh" >> Production_commands_$i.sh
echo "" >> Production_commands_$i.sh
echo "cd /home/jpedropino@UA.PT/Workstation/MadGraph/MG5_aMC_v2_7_0/Backgrounds/ZW_$i/bin" >> Production_commands_$i.sh
echo "./cleanall" >> Production_commands_$i.sh
echo "" >> Production_commands_$i.sh
echo "cd /home/jpedropino@UA.PT/Workstation/MadGraph/MG5_aMC_v2_7_0/Backgrounds/ZW_$i/Events/run_01" >> Production_commands_$i.sh
...
echo "mv \$File ZW_$i.root" >> Production_commands_$i.sh
done

for i in {1..6}; do
rm -r Scan_commands_$i.sh 2> /dev/null
touch Scan_commands_$i.sh 2> /dev/null
echo "!cp /home/jpedropino@UA.PT/Workstation/MadGraph/MG5_aMC_v2_7_0/Backgrounds/ZW_$i/Cards/pythia8_card_default.dat /home/jpedropino@UA.PT/Workstation/MadGraph/MG5_aMC_v2_7_0/Backgrounds/ZW_$i/Cards/pythia8_card.dat" >> Scan_commands_$i.sh
echo "!cp /home/jpedropino@UA.PT/Workstation/MadGraph/MG5_aMC_v2_7_0/Backgrounds/ZW_$i/Cards/delphes_card_ATLAS.dat /home/jpedropino@UA.PT/Workstation/MadGraph/MG5_aMC_v2_7_0/Backgrounds/ZW_$i/Cards/delphes_card.dat" >> Scan_commands_$i.sh
echo "launch Backgrounds/ZW_$i" >> Scan_commands_$i.sh
...
echo "cd /scratch_p/jpedropino/1-LQCollider-project/ZW" >> Submit_job_$i.sh 
